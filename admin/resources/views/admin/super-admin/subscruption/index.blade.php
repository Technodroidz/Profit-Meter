                                            ...
                                            <div class="col-lg-4">
                                                <div class="page-header-breadcrumb">
                                                    <ul class="breadcrumb-title">
                                                        ...
                                                        <li class="breadcrumb-item" style="float: left;"><a href="#!">Subscruption</a>
                                                        </li>
                                                    </ul>
                                                </div>
                                            </div>
                                                       ...
                                                       @csrf
                                                            <div class="row">
                                                                ...
                                                                <div class="col-sm-3 col-xs-12 form-group">
                                                                    ...
                                                                    <input type="text" class="form-control" name="amount" id="amount" value="{{@$getSubscribeData['0']['package_amount']}}" placeholder="$" step="any">
                                                                </div>
                                                                <div class="col-sm-3 col-xs-12 form-group">
