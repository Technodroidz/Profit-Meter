                ...
                <div class="navbar-wrapper">
                    ...
                    <div class="navbar-logo">
                        ...
                        <a href="{{asset('company-details')}}">
                            ...
                            <img src="{{asset('images/'.$getbasic['getcompany']['0']['logo'])}}" class="img-circle" hight="120px" width="100px" alt="User Image">
                            @else
                            ...
                            <li class="user-profile header-notification">
                                <div class="dropdown-primary dropdown">
                                    <div class="dropdown-toggle" data-toggle="dropdown">
                                         @if(!empty(Auth::user()->owner_pic))
                                            <img src="{{asset('images/'.Auth::user()->owner_pic)}}" class="img-circle" hight="120px" width="100px" alt="User Image">
                                            @else
                                            <img src="{{asset('')}}admin/dist/img/user2-160x160.jpg" class="img-circle " alt="User Image">
                                          @endif
                    ...
                    <nav class="pcoded-navbar">
                        <div class="pcoded-inner-navbar main-menu">
                            ...
                            <ul class="pcoded-item pcoded-left-item">
                                ...
                                <li class="">
                                    <a href="{{asset('subscribtion')}}">
                                        <span class="pcoded-micon"><i class="feather icon-package"></i></span>
                                        <span class="pcoded-mtext">Subscruption Plan</span>
                                    </a>
                                </li>
