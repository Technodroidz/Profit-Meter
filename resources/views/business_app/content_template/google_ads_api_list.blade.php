    ...
    <style>
        ...
        <div class="container-fluid p-0 sm_padding_15px">
            <div class="row justify-content-center">
                ...
                <div class="col-lg-6">
                    <form method="POST" action="{{ route('google_ads_api_detail') }}">
                        @csrf
                            ...
                            <div class="white_box_tittle">
                                <div class="main-title2 ">
                                    ...
                                    <div class="input-group mb-3">
                                        ...
                                        <input name="api_url" value="get/customer" type="text" class="form-control" aria-describedby="basic-addon3" readonly="readonly">
                                    </div>
