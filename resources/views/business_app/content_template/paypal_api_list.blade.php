    ...
    <style>
        ...
        <div class="container-fluid p-0 sm_padding_15px">
            <div class="row justify-content-center">
                ...
                <div class="col-lg-6">
                    <form method="POST" action="{{ route('paypal_api_detail') }}">
                        @csrf
                        <div class="card_box box_shadow position-relative mb_30">
                            <div class="white_box_tittle">
                                <div class="main-title2 ">
                                    <h4 class="mb-2 nowrap ">Get Disputes</h4>
                                    <div class="input-group mb-3">
                                        <div class="input-group-prepend">
                                            <span class="input-group-text">Api</span>
                                        </div>
                                        <input name="api_url" value="disputes" type="text" class="form-control" aria-describedby="basic-addon3" readonly="readonly">
                                    </div>
