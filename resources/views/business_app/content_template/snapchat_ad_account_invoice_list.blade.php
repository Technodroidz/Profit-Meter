            ...
            <div class="white_card card_height_100 mb_30">
                <div class="white_card_header">
                    <div class="white_box_tittle list_header mb-0">
                        <h4>Snapchat Ad Account Invoices</h4>
                            ...
                            <table class="table lms_table_active3 ">
                                <thead>
                                    <tr>
                                        ...
                                        <th scope="col">Amount In Cent</th>
                                    ...
                                    <tr>
                                        <td>
                                            <div class="trade d-flex align-items-center">
                                                ...
                                                <span class="ml-3"> {{$value['invoice']['id']}} </span>
                                            </div>
                                        </td>
                                        <td> {{$value['invoice']['customer']['name']}} </td>
                                        <td> {{$value['invoice']['amount_cent']}} </td>
                                        <td> {{$value['invoice']['currency']}} </td>
                                        <td> {{$value['invoice']['billing_period']}} </td>
                                        <td> {{$value['invoice']['invoice_status']}}</td>
                                        <td> {{$value['invoice']['created_at']}}</td>
