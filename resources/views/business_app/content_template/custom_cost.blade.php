...
<div class="container-fluid p-0 ">
            ...
            <div class="row">
               ...
               <div class="col-md-3"><label>Show <select name="example_length" aria-controls="example" class=""><option value="10">10</option><option value="25">25</option><option value="50">50</option><option value="-1">All</option></select> entries</label></div>
               <div class="col-md-3">
                   <div class="view_btns">
        ...
        <div class="modal-body">
         <div class="mb-3">
                            ...
                            <div class="inlineitem">  <input type="checkbox" aria-label="">&nbsp; &nbsp;
                                    <p class="mb-0 ">Include in marketing & CAC</p></div>
